...
export default async function handler(req, res) {
  ...
  // COMPACT & PREMIUM BRANDED EMAIL TEMPLATE (WITH GMAIL APP COMPATIBLE FONTS)
  const htmlContent = `
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td style="padding: 6px 0;">
                              ...
                              <div style="font-size: 14px; color: #0f172a; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">${fullName}</div>
                            </td>
                          </tr>
                          <tr>
                            <td style="padding: 6px 0;">
                          ...
                          <tr>
                            <td style="padding: 6px 0;">
                              ...
                              <div style="font-size: 14px; color: #0f172a; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">${phone}</div>
                            </td>
                          </tr>
                        </table>
                      </td>
                      ...
                      <td width="48%" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            <td style="padding: 6px 0;">
                              <div style="font-size: 12px; color: #64748b; font-weight: 500; margin-bottom: 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">Service Type</div>
                              <div style="font-size: 14px; color: #0f172a; font-weight: 600; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">${service}</div>
                            </td>
                          </tr>
                          ` : ''}
                          <tr>
                            <td style="padding: 6px 0;">
                              <div style="font-size: 12px; color: #0f172a; font-weight: 700; margin-bottom: 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">Estimated Budget</div>
                              <div style="font-size: 16px; font-weight: 700; color: ${BRAND_COLOR}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
