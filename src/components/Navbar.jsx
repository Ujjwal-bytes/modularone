...
export default function Navbar() {
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16 md:h-20">
                    {/* Logo - Text Only for Prime Furniture */}
                    <motion.div
                        variants={logoVariants}
                        initial="initial"
                        animate="animate"
                        ...
                        whileTap={{ scale: 0.98 }}
                    >
                        <Link to="/" className="flex-shrink-0 flex items-center gap-1 group transition-all" aria-label="Prime Furniture Home">
                            <span className="text-xl md:text-2xl font-bold text-[#1A2A4F] tracking-tight group-hover:text-[#C9A03D] transition-colors duration-300">
                                Prime
                            </span>
                            <span className="text-xl md:text-2xl font-bold text-[#C9A03D] tracking-tight group-hover:text-[#1A2A4F] transition-colors duration-300">
                                Furniture
                            </span>
                        </Link>
                    </motion.div>
