...
import {
  Star, Award, Shield, Clock, ArrowRight,
  Instagram, Sparkles, Compass, ArrowUpRight, Phone
} from 'lucide-react';
import { categories, products } from '../data/products';
import CategoryCard from '../components/CategoryCard';
import ProductCard from '../components/ProductCard';
...
// Updated JSON-LD for Prime Furniture
const orgJsonLd = {
  "@context": "https://schema.org",
  "@type": "Organization",
  "name": "Prime Furniture",
  "url": "https://primefurniture.in",
  "logo": "https://primefurniture.in/logo.png",
  "contactPoint": {
    "@type": "ContactPoint",
    "telephone": "+91-89764-23189",
    "contactType": "customer service",
    "areaServed": "IN",
    "availableLanguage": "en"
  },
...
const websiteJsonLd = {
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://primefurniture.in/products?search={search_term_string}",
    "query-input": "required name=search_term_string"
  }
};
...
// Updated testimonials for Prime Furniture
const testimonialsData = [
  {
    id: 1,
    name: "Rajesh Kumar",
    location: "Vasai, Maharashtra",
    rating: 5,
    review: "Prime Furniture has been my go-to for all furniture needs for years. Their custom sofa set is absolutely stunning and the quality is unmatched. Highly recommended!",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop",
    projectImage: "https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=400&h=300&fit=crop"
  },
  {
    id: 2,
    name: "Priya Sharma",
    location: "Mumbai, Maharashtra",
    rating: 5,
    review: "I got my customised mattress from Prime Furniture and it's the best investment I've made. Perfect firmness and quality. Their repair service is also excellent!",
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop",
    projectImage: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=400&h=300&fit=crop"
  },
  {
    id: 3,
    name: "Amit Patel",
    location: "Palghar, Maharashtra",
    rating: 4,
    review: "Prime Furniture restored my old dining table beautifully. Their repair service is top-notch. The team is professional and the quality of work is excellent.",
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop",
    projectImage: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=300&fit=crop"
  }
];

// Gallery Images (keeping same images but updating alt text)
const galleryImagesData = [
...
// Updated features for Prime Furniture
const featuresData = [
  { icon: Award, title: "Premium Materials", desc: "We use only the highest-grade wood and finishes to ensure your furniture lasts for generations." },
  { icon: Shield, title: "Quality Assurance", desc: "Every piece undergoes rigorous quality checks before delivery, backed by our 4.7★ Google rating." },
  { icon: Sparkles, title: "Expert Craftsmanship", desc: "Skilled artisans with decades of experience bring precision and care to every piece we create." },
  { icon: Clock, title: "On-Time Delivery", desc: "We respect your time with strict adherence to delivery timelines without compromising on quality." }
];
...
export default React.memo(function Home() {
  ...
  // Updated counter values for Prime Furniture
  const projectsCounter = useAnimatedCounter(500, 2000);
  const ratingCounter = useAnimatedCounter(4.7, 2000);
  const architectsCounter = useAnimatedCounter(12, 2000);
  const scopeCounter = useAnimatedCounter(84, 2000);
  ...
  return (
    <div className="bg-white selection:bg-[#C9A03D] selection:text-white overflow-hidden">
      <Helmet>
        {/* Updated title and meta for Prime Furniture */}
        <title>Prime Furniture | Premium Furniture, Custom Mattresses & Expert Repairs in Vasai</title>
        <meta name="description" content="Prime Furniture offers premium furniture, customised mattresses, office chairs, and expert repair services in Vasai West. 4.7★ rating with 84+ reviews. Trusted since 2008." />
        <meta name="keywords" content="furniture repairs Vasai, customised mattress Vasai, sofas Vasai, office chairs Vasai, Prime Furniture, furniture store Vasai" />
        <link rel="canonical" href="https://primefurniture.in" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://primefurniture.in/" />
        <meta property="og:title" content="Prime Furniture | Premium Furniture, Custom Mattresses & Expert Repairs in Vasai" />
        <meta property="og:description" content="Premium furniture, customised mattresses, office chairs, and expert repair services in Vasai West. 4.7★ rating with 84+ reviews." />
        <meta property="og:image" content="https://primefurniture.in/og-home.jpg" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://primefurniture.in/" />
        <meta property="twitter:title" content="Prime Furniture | Premium Furniture, Custom Mattresses & Expert Repairs in Vasai" />
        <meta property="twitter:description" content="Premium furniture, customised mattresses, office chairs, and expert repair services in Vasai West." />
        <meta property="twitter:image" content="https://primefurniture.in/og-home.jpg" />
      ...
      {/* Featured Categories / Collections - Updated content */}
      <motion.section
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              className="max-w-xs text-sm sm:text-base text-gray-500 font-medium leading-relaxed border-l-2 border-gray-100 pl-6"
            >
              Trusted since 2008 with 4.7★ rating from 84+ satisfied customers in Vasai West.
            </motion.p>
          </motion.div>
      ...
      {/* Best Sellers Section - Updated content */}
      <motion.section
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={staggerItem} className="space-y-2">
              ...
              <p className="text-sm text-gray-500 font-medium">
                Discover our most popular furniture collections loved by thousands.
              </p>
            </motion.div>
            <motion.div variants={staggerItem}>
              <Link
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.span variants={staggerItem} className="text-xs font-bold text-[#C9A03D] uppercase tracking-widest">Why Choose Us</motion.span>
            <motion.h2 variants={staggerItem} className="text-3xl sm:text-4xl font-black tracking-tight">
              The Prime Furniture Advantage
            </motion.h2>
            <motion.p variants={staggerItem} className="text-sm text-gray-400 font-medium">
              Experience unparalleled quality and service with our premium furniture solutions.
            </motion.p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={staggerItem} className="text-sm text-gray-500 font-medium">
              Real stories from satisfied customers who chose Prime Furniture.
            </motion.p>
          </motion.div>
      ...
      {/* Instagram Gallery Section - Updated content */}
      <motion.section
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={staggerItem} className="text-xs sm:text-sm text-gray-500 font-medium">
              Get inspired by our latest furniture creations and transformations on Instagram.
            </motion.p>
          </motion.div>
          ...
          >
            {galleryImages.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`Prime Furniture Project ${index + 1}`}
                  className="w-full h-full object-cover transition-transform duration-500 ease-out group-hover:scale-105"
                  loading="lazy"
                  width="600"
                  height="600"
          ...
          >
            <a
              href="https://instagram.com/primefurniture"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-6 py-3.5 bg-gradient-to-r from-gray-900 to-gray-800 hover:from-[#C9A03D] hover:to-[#B8922E] text-white text-xs font-bold tracking-wider uppercase rounded-xl shadow-md transition-all duration-300 hover:shadow-lg active:scale-95"
            >
              <Instagram size={16} />
              <span>Follow @PrimeFurniture</span>
            </a>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-gray-400 font-medium max-w-2xl mx-auto leading-relaxed"
          >
            Visit our showroom in Manickpur, Vasai West or call us for expert consultation on furniture, custom mattresses, or repairs.
          </motion.p>
          <motion.div
            variants={staggerItem}
            className="flex flex-wrap justify-center gap-4 pt-2"
