...
import { 
  ...
  Send, CheckCircle, X, Building, Calendar, 
  DollarSign, User, AlertCircle, ShieldCheck, Navigation,
  Car, Train, Bus, Compass, ExternalLink, Wrench, Sofa, Bed
} from 'lucide-react';
...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    const msg = `*Prime Furniture Enquiry*%0A%0A*Name:* ${formData.fullName || 'Guest'}%0A*Service:* ${formData.service || 'Furniture'}%0A*Phone:* ${formData.phone || 'Not provided'}`;
    window.open(`https://wa.me/918976423189?text=${msg}`, '_blank');
  };

  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Contact Us | Prime Furniture - Premium Furniture & Repairs in Vasai</title>
        <meta name="description" content="Get in touch with Prime Furniture for premium furniture, custom mattresses, and expert repair services. Visit our showroom in Manickpur, Vasai West or call us at 089764 23189." />
        <meta name="keywords" content="contact furniture store Vasai, furniture repairs Vasai, custom mattress Vasai, Prime Furniture showroom" />
        <link rel="canonical" href="https://primefurniture.in/contact" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://primefurniture.in/contact" />
        <meta property="og:title" content="Contact Us | Prime Furniture - Premium Furniture & Repairs in Vasai" />
        <meta property="og:description" content="Get in touch with Prime Furniture for premium furniture, custom mattresses, and expert repair services. Visit our showroom in Manickpur, Vasai West." />

        {/* Twitter */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Contact Us | Prime Furniture" />
        <meta name="twitter:description" content="Get in touch with Prime Furniture for premium furniture, custom mattresses, and expert repair services." />
      </Helmet>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-6 bg-[#1A2A4F]/5 border border-[#1A2A4F]/10">
            <MessageCircle className="w-4 h-4 text-[#1A2A4F]" />
            <span className="text-xs font-bold uppercase tracking-widest text-[#1A2A4F]">Contact Us</span>
          </div>
          <h1 className="text-4xl md:text-7xl font-bold text-gray-900 mb-6 tracking-tight">
            Premium <span className="text-[#1A2A4F]">Furniture.</span>
          </h1>
          <p className="text-gray-500 max-w-2xl mx-auto text-lg md:text-xl font-light">
            From custom sofas to expert repairs — visit our showroom in Manickpur, Vasai West. 
            Trusted since <span className="font-semibold text-[#C9A03D]">2008</span> with 4.7★ rating.
          </p>
        </div>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            <div className="grid gap-6">
              {[
                { icon: MapPin, label: 'Visit Showroom', val: 'Stella Rd, Navghar Manikpur', sub: 'Manickpur, Vasai West, MH - 401202' },
                { icon: Phone, label: 'Call Us', val: '+91 89764 23189', sub: 'Available 10AM - 7PM' },
                { icon: Mail, label: 'Email Us', val: 'info@primefurniture.com', sub: 'For inquiries and quotes' }
              ].map((item, i) => (
                <motion.div 
                  key={i} 
                  className="flex gap-5 p-6 rounded-3xl border border-gray-100 bg-white hover:shadow-xl hover:shadow-[#1A2A4F]/5 transition-all duration-500 group"
            ...
            <div className="p-8 rounded-[2rem] bg-[#1A2A4F] text-white overflow-hidden relative">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <Clock className="text-[#C9A03D]" size={24} />
                  <h3 className="text-xl font-bold">Showroom Hours</h3>
                </div>
                <div className="space-y-3 opacity-90 font-light">
                  <div className="flex justify-between border-b border-white/10 pb-2">
                    <span>Mon — Sat</span>
                ...
                <div className="mt-8 pt-8 border-t border-white/10 flex items-center gap-4">
                  ...
                  <p className="text-xs text-white/60 leading-relaxed">
                    ⭐ 4.7 Rating · 84+ Reviews · Trusted Since 2008
                  </p>
                </div>
              </div>
              <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-[#C9A03D]/10 rounded-full blur-3xl"></div>
          ...
          >
            <div className="bg-white rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,0.08)] border border-gray-50 overflow-hidden">
              <div className="bg-[#1A2A4F] p-10 text-white">
                ...
                <p className="text-white/60 font-light">Fill in your details and we'll get back to you within 2 hours.</p>
              </div>
              ...
              {submitted ? (
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="p-10 space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {[
                      { name: 'fullName', label: 'Full Name', icon: User, type: 'text', ph: 'e.g. Rajesh Patil' },
                      { name: 'email', label: 'Email Address', icon: Mail, type: 'email', ph: 'rajesh@example.com' },
                      { name: 'phone', label: 'Phone Number', icon: Phone, type: 'tel', ph: '8976423189' },
                      { name: 'budget', label: 'Approx. Budget', icon: DollarSign, type: 'text', ph: 'e.g. 50,000 - 2 Lakhs' }
                    ].map((field) => (
                      <div key={field.name} className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">{field.label}</label>
                        <div className="relative group">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Service Required</label>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {['Sofas', 'Mattresses', 'Office Chairs', 'Repairs'].map(s => (
                        <button
                          key={s}
                          type="button"
                          onClick={() => setFormData(prev => ({ ...prev, service: s }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, message: e.target.value }))}
                      className="w-full p-5 bg-gray-50/50 border border-gray-100 rounded-3xl focus:bg-white focus:ring-4 focus:ring-[#1A2A4F]/5 focus:border-[#1A2A4F] outline-none transition-all resize-none font-medium"
                      placeholder="Briefly describe your furniture needs..."
                    ></textarea>
                  </div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Visit Our <span className="text-[#1A2A4F]">Showroom</span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto">
              Come see our premium furniture collection and experience our craftsmanship in person.
            </p>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 group">
            ...
            {/* Google Maps Embed - Manickpur, Vasai West */}
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.100000000000!2d72.835000!3d19.400000!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7a92edf56d075%3A0x5f09700c1bbc865b!2sManickpur%2C%20Vasai%20West%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="480"
              style={{ border: 0 }}
              allowFullScreen
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="Prime Furniture Location - Manickpur, Vasai West"
              className="w-full transition-opacity duration-500"
              onLoad={() => setMapLoaded(true)}
            ></iframe>
            ...
            <div className="absolute top-6 left-6 right-6 md:left-auto md:right-6 md:w-96 bg-white/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border border-white/20 z-20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-gray-900 text-lg mb-1">Stella Rd, Manickpur</h4>
                  <p className="text-xs text-gray-500 mb-3 leading-relaxed">
                    Stella Rd, Navghar Manikpur, Manickpur,<br />
                    Vasai West, Maharashtra - 401202
                  </p>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span className="text-[10px] px-2 py-1 rounded-full bg-green-50 text-green-600 font-medium">Open Until 7PM</span>
                    <span className="text-[10px] px-2 py-1 rounded-full bg-blue-50 text-blue-600 font-medium">Free Parking</span>
                    <span className="text-[10px] px-2 py-1 rounded-full bg-yellow-50 text-yellow-600 font-medium">⭐ 4.7</span>
                  </div>
                  <a 
          ...
          <div className="mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: Car, title: 'By Car', desc: '10 min from Vasai West Station', detail: 'Ample parking available' },
                { icon: Train, title: 'By Train', desc: 'Nearest: Vasai Road Station', detail: 'Auto available from station' },
                { icon: Bus, title: 'By Bus', desc: 'Navghar Manikpur Bus Stop', detail: 'Well connected by local buses' }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  className="flex items-start gap-4 p-5 rounded-2xl bg-gray-50/50 border border-gray-100 hover:bg-white hover:shadow-lg transition-all duration-300"
          ...
          <div className="mt-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { name: 'Vasai West Station', dist: '2.5 km', time: '10 min', icon: Train },
                { name: 'Navghar Bus Stop', dist: '0.3 km', time: '2 min walk', icon: Bus },
                { name: 'D-Mart Bhabhola', dist: '1.8 km', time: '6 min', icon: Building },
                { name: 'Manickpur Beach', dist: '4.5 km', time: '12 min', icon: Compass }
              ].map((landmark, idx) => (
                <motion.div
                  key={idx}
                  className="flex items-center gap-3 p-4 rounded-xl bg-gray-50/50 border border-gray-100 hover:bg-white hover:shadow-md transition-all cursor-pointer group"
          ...
          <div className="mt-8 p-5 rounded-2xl bg-[#1A2A4F]/5 border border-[#1A2A4F]/10 text-center">
            <p className="text-sm text-gray-600">
              📍 <span className="font-semibold">Free Consultation Available</span> — Walk in anytime between 10 AM - 7 PM
            </p>
          </div>
        </motion.div>
      </div>
