...
const teamMembers = [
  {
    id: 1,
    name: "Rajesh Patil",
    role: "Proprietor & Lead Craftsman",
    experience: "18+ years in furniture craftsmanship",
    image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&auto=format&fit=crop&q=80",
    linkedin: "#",
    email: "rajesh@primefurniture.com",
    quote: "Every piece of furniture tells a story of precision and passion."
  },
  {
    id: 2,
    name: "Suresh Yadav",
    ...
    image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=500&auto=format&fit=crop&q=80",
    linkedin: "#",
    email: "suresh@primefurniture.com",
    quote: "Design is about creating pieces that last for generations."
  },
  {
    id: 3,
    name: "Anita Deshmukh",
    role: "Custom Mattress Specialist",
    experience: "10+ years in mattress crafting",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=500&auto=format&fit=crop&q=80",
    linkedin: "#",
    email: "anita@primefurniture.com",
    quote: "A good mattress is the foundation of a good life."
  },
  {
    id: 4,
    name: "Vikram Singh",
    role: "Senior Repair Technician",
    experience: "15+ years in furniture restoration",
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=500&auto=format&fit=crop&q=80",
    linkedin: "#",
    email: "vikram@primefurniture.com",
    quote: "Restoring furniture is like bringing history back to life."
  }
];

const brandAssets = {
  heroKitchen: "https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=1600&auto=format&fit=crop&q=80",
  workshop: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=1600&auto=format&fit=crop&q=80",
  team: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&auto=format&fit=crop&q=80",
};
...
export default function About() {
  return (
    <div className="min-h-screen bg-white selection:bg-[#C9A03D] selection:text-white overflow-hidden">
      <Helmet>
        <title>About Us | Prime Furniture - Premium Furniture & Repairs in Vasai</title>
        <meta name="description" content="Learn about Prime Furniture's 18+ year legacy in crafting premium furniture, custom mattresses, and expert repair services in Vasai West." />
        <meta name="keywords" content="furniture repairs Vasai, customised mattress Vasai, sofas Vasai, office chairs Vasai, Prime Furniture" />
        <link rel="canonical" href="https://primefurniture.in/about" />
        
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://primefurniture.in/about" />
        <meta property="og:title" content="About Us | Prime Furniture - Premium Furniture & Repairs in Vasai" />
        <meta property="og:description" content="Learn about Prime Furniture's 18+ year legacy in crafting premium furniture, custom mattresses, and expert repair services." />
        
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="About Us | Prime Furniture" />
        <meta name="twitter:description" content="Learn about Prime Furniture's 18+ year legacy in crafting premium furniture." />
      </Helmet>
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center px-4">
            ...
            {/* Subtitle */}
            <p className="text-white/80 text-xs md:text-sm tracking-[0.4em] uppercase mt-6 md:mt-8 font-light max-w-xs md:max-w-md mx-auto border-t border-white/20 pt-4">
              Premium Furniture · Repairs · Custom Mattresses
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-[#1A2A4F]"> 2008</span>
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Established in Manickpur, Vasai West, <span className="font-semibold text-[#1A2A4F]">Prime Furniture</span> has been a trusted name in the furniture industry for over 18 years. We specialize in creating premium furniture pieces, customised mattresses, and providing expert repair services.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Under the leadership of <span className="font-semibold text-[#1A2A4F]">Rajesh Patil</span>, our workshop combines traditional craftsmanship with modern techniques. Our team of 12+ skilled artisans and technicians handle everything from custom furniture design to complex restoration projects.
              </p>
              <p className="text-gray-600 leading-relaxed">
                With a Google rating of <span className="font-semibold text-[#1A2A4F]">4.7 stars</span> from 84+ satisfied customers, we take pride in delivering quality that stands the test of time.
              </p>
              <motion.div 
                className="flex items-center gap-4 pt-4"
                whileHover={{ scale: 1.02 }}
              >
                ...
                <div className="text-sm text-gray-500">
                  <span className="font-semibold text-gray-900">12+ Experts</span> ready to serve you
                </div>
              </motion.div>
            </motion.div>
            <motion.div 
            ...
            >
              <motion.div 
                ...
                className="relative rounded-2xl overflow-hidden shadow-2xl"
              >
                <img src={brandAssets.heroKitchen} alt="Prime Furniture Premium Collection" className="w-full h-full object-cover" loading="lazy" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">"Quality is not an act, it's a habit"</p>
                        <p className="text-xs text-gray-500">- Rajesh Patil, Proprietor</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">What Drives Us</h2>
            <p className="text-gray-600">Our principles guide every piece we create and every service we provide</p>
          </div>
          ...
          >
            {[
              { icon: ShieldCheck, title: "Quality First", description: "We use premium materials and time-tested techniques for furniture that lasts generations.", color: "#1A2A4F" },
              { icon: TrendingUp, title: "Innovation", description: "Constantly evolving our designs to bring you the latest in furniture trends.", color: "#C9A03D" },
              { icon: Users, title: "Customer-Centric", description: "Your vision, our expertise — collaborative approach to every project.", color: "#1A2A4F" },
              { icon: Clock, title: "Timely Service", description: "Strict adherence to delivery timelines without compromising on quality.", color: "#C9A03D" },
              { icon: Wrench, title: "Expert Repairs", description: "Skilled restoration services that breathe new life into your furniture.", color: "#1A2A4F" },
              { icon: Award, title: "Excellence", description: "Committed to exceeding expectations in every detail, with 4.7★ Google rating.", color: "#C9A03D" }
            ].map((value, index) => {
              const Icon = value.icon;
              return (
                <motion.div 
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          >
            ...
            <motion.h2 variants={staggerItem} className="text-4xl font-bold text-white mb-4">Where Craftsmanship Meets Precision</motion.h2>
            <motion.p variants={staggerItem} className="text-white/80 mb-8 leading-relaxed">
              Our workshop in Manickpur, Vasai West is equipped with modern machinery and staffed by skilled artisans who bring decades of experience to every project — from custom furniture to precision repairs.
            </motion.p>
            <motion.div variants={staggerItem} className="flex flex-wrap gap-6">
              {["Custom Furniture Design", "Expert Repair Services", "Customised Mattresses"].map((item, i) => (
                <motion.div 
                  key={i} 
                  className="flex items-center gap-3"
                  whileHover={{ scale: 1.05 }}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">The Experts Behind The Craft</h2>
            <p className="text-gray-600">Dedicated professionals committed to creating furniture that lasts a lifetime</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl font-bold text-gray-900">Committed to Excellence</h2>
              <p className="text-gray-600 leading-relaxed">
                We maintain rigorous quality standards across every aspect of our work, from material selection to final delivery and after-sales service.
              </p>
              <motion.div 
                className="space-y-4"
                variants={staggerContainer}
              ...
              >
                {[
                  { icon: Layers, title: "Premium Materials", desc: "Only highest-grade wood and finishes" },
                  { icon: Fingerprint, title: "Custom Craftsmanship", desc: "Each piece is uniquely crafted to your specifications" },
                  { icon: ShieldCheck, title: "After-Sales Support", desc: "Comprehensive service and repair support" }
                ].map((item, i) => {
                  const Icon = item.icon;
                  return (
                    <motion.div 
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Our Commitments</h3>
                </motion.div>
                <motion.div 
                  className="space-y-3"
                  variants={staggerContainer}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 mb-4">
              <span className="w-8 h-0.5 bg-[#C9A03D]"></span>
              <span className="text-xs font-semibold text-[#1A2A4F] uppercase tracking-wider">Our Services</span>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">What We Offer</h2>
            <p className="text-gray-600">From custom furniture to expert repairs — we do it all</p>
          </div>
          ...
          >
            {[
              { icon: Sofa, title: "Couches & Sofas", desc: "Custom-made sofas designed for comfort and style" },
              { icon: Bed, title: "Customised Mattresses", desc: "Premium mattresses tailored to your needs" },
              { icon: Armchair, title: "Office Chairs", desc: "Ergonomic and stylish office seating solutions" },
              { icon: Wrench, title: "Expert Repairs", desc: "Professional restoration and repair services" }
            ].map((service, index) => {
              const Icon = service.icon;
              return (
                <motion.div 
                  key={index} 
                  className="group p-6 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300"
                  variants={staggerItem}
                ...
                >
                  <motion.div 
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                    className="w-14 h-14 bg-[#1A2A4F]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#1A2A4F]/20 transition-all duration-300"
                  >
                    <Icon className="w-7 h-7 text-[#1A2A4F]" />
                  </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p 
            ...
            className="text-white/80 mb-8 max-w-2xl mx-auto"
          >
            Visit our showroom in Manickpur, Vasai West or call us for a consultation.
          </motion.p>
          <motion.div 
            variants={staggerItem}
            className="flex flex-col sm:flex-row gap-4 justify-center"
          >
            ...
            >
              <Phone size={18} />
              Call Us: 089764 23189
            </motion.a>
            <motion.a 
              href="https://maps.google.com/?q=Prime+Furniture+Stella+Rd+Navghar+Manikpur+Vasai+West"
              target="_blank"
          ...
          >
            ⭐ 4.7 · 84+ Reviews · Stella Rd, Navghar Manikpur, Manickpur, Vasai West
          </motion.p>
        </div>
      </motion.section>
    </div>
